...
<html lang="en">
  <head>
    ...
    <title>SCU | SCU Templates and Modules | Interior Page, Three Columns</title>
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-sm-4">
            ...
            <ul>
              ...
              <li class="active"><a href="inside-jumbotron-three-columns.php">Inside Page: Jumbotron Three Columns</a></li>
