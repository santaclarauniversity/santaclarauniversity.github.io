...
<html lang="en">
  <head>
    ...
    <title>SCU | SCU Templates and Modules | Header: Black Site Nav</title>

	<?php require('includes/head.php'); ?>
  </head>
  <body>
    <a class="sr-only sr-only-focusable" href="#content">Skip to main content</a>
          <header class="site-header site-header-custom-title black-nav">

      <div class="site-header-text-and-search" style="background-image:url(/_examples/bg-header-nanostructures.jpg);background-position: 60% 50%;">
        <div class="container">
          <div class="row">
            <div class="col-xs-9 col-sm-9 site-header-titles">
              <a href="index.html" class="wordmarks"><img src="css/assets/header-small-school-of-engineering.png" srcset="css/assets/header-small-school-of-engineering@2x.png 1.5x" alt="School of Engineering" width="292" height="15" />
                <img src="css/assets/header-large-center-for-nanostructures.png" srcset="css/assets/header-large-center-for-nanostructures@2x.png 1.5x" alt="Center For Nanostructures" width="674" height="28" /></a>
            </div>
          </div>
          <div class="row">
      ...
      <div class="row">
        <div class="col-sm-8">
          <h1 class="page-title">Header: Black Site Nav</h1>

          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">Section Title</a></li>
            <li><a href="#">Parent Page</a></li>
            <li class="active">Header: Black Site Nav</li>
          </ol>
