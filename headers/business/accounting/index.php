...
<html lang="en">
  <head>
    ...
    <title>Accounting - Leavey School of Business - Santa Clara University</title>
    ...
    <div class="subheader module" style="background-image:url('/headers/_assets/images/accounting.jpg');">
      <div class="container">
        <div class="row">
    		  <div class="col-sm-8">
		        <h1>
