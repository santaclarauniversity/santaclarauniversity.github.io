...
<html lang="en">
  <head>
    ...
    <title>Office of the Provost - Santa Clara University</title>
  
	<?php require('../../includes/head.php'); ?>
	
  </head>  
  <body class="stone-nav">
    ...
    <header class="site-header site-header-with-seal">
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 col-sm-9 site-header-titles">
                ...
                <div class="wordmarks">
           		<a href="#" class="title-large">Name of This Office</a>
           		<a href="/" class="title-small">Office of the Provost</a>
                </div>
              </div>
              <div class="col-xs-12 col-sm-3 hidden-md hidden-lg clearfix site-header-search-and-toggles">
        ...
        <nav class="main-navigation offcanvas-left affix-top"><div class="container sidebar-offcanvas"><ul class="nav nav-pills"><li class="dropdown" id="toplink2942"><a href="/provost/teaching-and-learning/">Navigation for This Office or Department</a></li></ul></div></nav>
    ...
    <div id="extra-space-for-mockup" class="container" style="height: 400px;">
         <ul>
			<li><a href="index.php">Provost home page</a></li>
			<li><a href="sub1.php">Sub-office / department type 1</a></li>
			<li><a href="sub2.php">Sub-office / department type 2</a></li>
			<li><a href="sub3.php">Sub-office / department type 3</a></li>
			<li><a href="sub4.php">Sub-office / department type 4</a></li>
         </ul>
    </div>
