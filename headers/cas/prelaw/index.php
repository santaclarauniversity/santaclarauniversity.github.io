...
<html lang="en">
  <head>
    ...
    <title>Pre-Law - College of Arts and Sciences - Santa Clara University</title>
    ...
    <div class="subheader module" style="background-image:url('/headers/_assets/images/prelaw.jpg');">
      <div class="container">
        <div class="row">
    		  <div class="col-sm-8">
    			    <h1>
    			      <span>Advising in </span>Pre-Law
    			    </h1>
    		  </div>
          <div class="col-sm-4">
