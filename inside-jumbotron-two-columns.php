...
<html lang="en">
  <head>
    ...
    <title>SCU | SCU Templates and Modules | Interior Page, Two Columns</title>
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-sm-4">
            ...
            <ul>
              ...
              <li class="active"><a href="inside-jumbotron-two-columns.php">Inside Page: Jumbotron Two Columns</a></li>
              <li>
