...
<html lang="en">
  <head>
    ...
    <title>SCU | SCU Templates and Modules | Landing Hero Features</title>
  ...
  <body>
    ...
    <div class="landing hero module" style="background-image:url(_examples/landing-hero-fire.jpg);">
      <div class="container">
        <h1>Academics</h1>
        <div class="hero-body white-text">
          <div class="row">
            <div class="col-xs-6 col-xs-push-6 col-sm-4 col-sm-push-8">
              <div class="strip">
                <h5>Can We?</h5>
                <h6>Clean Cookstoves</h6>
                <p>Est eligendi optio SCU nihil impendit quo minus id um qui eum fugio quo voltip.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-8">
          <h1 class="page-title">Landing Hero Features</h1>

          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">Section Title</a></li>
            <li><a href="#">Parent Page</a></li>
            <li class="active">Landing Hero Features</li>
          </ol>

          <div class="intro">
            <p>Landing pages have a different type of hero feature module.</p>
          </div>
        </div>
        <div class="col-sm-4">
