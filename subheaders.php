...
<html lang="en">
  <head>
    ...
    <title>SCU | SCU Templates and Modules | Subheaders</title>
  ...
  <body>
    ...
    <div class="office subheader module">
      ...
      <div class="row">
        <div class="col-sm-8">
          <h1 class="page-title">Subheaders</h1>

          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">Section Title</a></li>
            <li><a href="#">Parent Page</a></li>
            <li class="active">Subheaders</li>
          </ol>

          <div class="intro">
            <p>Subheader modules are for section/office titles.</p>
          </div>
