      <div class="site-header-text-and-search" style="background-image:url(broncobench.jpg); background-size: cover; background-repeat: repeat;">
        <div class="container">
          <div class="row">
	          <div class="col-sm-3 hidden-xs site-header-titles">
	            <div class="wordmarks">
	              <img src="BBF-logo.png" style="width:200px; height:200px;"/>
	            </div>
		          
	          </div>
            <div class="col-sm-9 site-header-titles">
	            <div class="wordmarks">
	              <a href="index.php" class="title-large"> Bronco Bench Foundation</a>
	              <a href="/" class="title-small"> Santa Clara University</a>
	            </div>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-12 col-sm-3 visible-xs-block clearfix site-header-search-and-toggles">
