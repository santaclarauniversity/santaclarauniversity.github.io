...
<html lang="en">
  <head>
    ...
    <title>SCU | SCU Templates and Modules | Header: Core Nav, Core Gateways</title>
  ...
  <body>
	<?php require('includes/header.php'); ?>
      ...
      <div class="row">
        <div class="col-sm-8">
          <h1 class="page-title">Header: Core Nav, Core Gateways</h1>

          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">Section Title</a></li>
            <li><a href="#">Parent Page</a></li>
            <li class="active">Header: Core Nav, Core Gateways</li>
          </ol>
