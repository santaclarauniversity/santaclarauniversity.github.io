...
<html lang="en">
  <head>
    ...
    <title>SCU | SCU Templates and Modules | Header: Gray Site Nav</title>
  ...
  <body>
    <a class="sr-only sr-only-focusable" href="#content">Skip to main content</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-sm-9 site-header-titles">
              <a href="index.html" class="wordmarks"><img src="css/assets/header-large-school-of-engineering.png" srcset="css/assets/header-large-school-of-engineering@2x.png 1.5x" alt="School of Engineering" width="552" height="28">
                <img src="css/assets/header-small-Santa-Clara-University.png" srcset="css/assets/header-small-Santa-Clara-University@2x.png 1.5x" alt="Santa Clara University" width="296" height="16"></a>
            </div>
          </div>
          <div class="row">
      ...
      <div class="row">
        <div class="col-sm-8">
          <h1 class="page-title">Header: Gray Site Nav</h1>

          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">Section Title</a></li>
            <li><a href="#">Parent Page</a></li>
            <li class="active">Header: Gray Site Nav</li>
          </ol>
