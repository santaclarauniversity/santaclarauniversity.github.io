...
<html lang="en">
  <head>
    ...
    <title>SCU | SCU Templates and Modules | Full-Width Modules</title>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="page-title">
            <div class="row">
              <div class="col-sm-3 col-sm-push-9 back-to-site-home">
                <a href="#">&laquo; Back to <span>Site Home</span></a>
              </div>
              <div class="col-sm-9 col-sm-pull-3"><h1>Full-Width Modules</h1></div>
            </div>
          </div>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Full Width Modules</li>
          </ol>

          <div class="intro">
            <p>Full-width modules for full-width pages.</p>
          </div>
          <h3>Jumbotron</h3>
          <p>Based on <a href="http://getbootstrap.com/javascript/#carousel">Bootstrap's carousel module</a>, with some extra CSS additions to have a fade transition instead of a slide effect.</p>
          <div class="full-width feature-gallery module">
...
<div id="feature-gallery-example" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner" role="listbox"><!-- Wrapper for slides -->
    <div class="item active">
      <img src="_examples/feature-gallery-sprinksgiving.jpg" alt="Sprinksgiving" width="1020" height="533">
    ...
    <div class="item">
      <img src="_examples/feature-gallery-nash.jpg" alt="" width="1020" height="533">
      <div class="carousel-caption">
        <p>PHOTO: And <a href="#">a link to a story</a> about this alumnus. <a href="#" class="feature-gallery-source">Source</a></p>
      </div>
    </div>
    <div class="item">
      <img src="_examples/feature-gallery-commencement.jpg" alt="Commencement 2014" width="1020" height="533">
      <div class="carousel-caption">
            ...
            <ul>
              ...
              <li>
                ...
                <ul class="multilevel-linkul-0">
                  ...
                  <li><a href="header-site-nav-site-gateways.php">Site Nav, Site Gateways</a>
